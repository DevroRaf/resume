...
//     image:          {type: 'jpeg', quality: 1}, // 0.98
//     html2canvas:    {scale: 6}, // 4
//     jsPDF:          {format: 'a4', orientation: 'portarit'}   
// }
var opt = {
    margin:       0,
    pagebreak:    { mode: ['avoid-all', 'css', 'legacy'] }, // lifesaver
    filename:     'limboResume.pdf',
    image:        { type: 'jpeg', quality: 1 },
    html2canvas:  { scale: 4 },
    jsPDF:        { format: 'a4', orientation: 'portrait' }
  };

// function to areaCv and html2pdf options
